...
sudo -u hadoopuser cat /home/hadoopuser/.ssh/id_rsa.pub  | sudo -u hadoopuser tee -a /home/hadoopuser/.ssh/authorized_keys
sudo -u hadoopuser ssh-keyscan -H 0.0.0.0 | sudo -u hadoopuser tee -a /home/hadoopuser/.ssh/known_hosts
sudo -u hadoopuser ssh-keyscan -H localhost | sudo -u hadoopuser tee -a /home/hadoopuser/.ssh/known_hosts
sudo -u hadoopuser ssh-keyscan -H $(hostname) | sudo -u hadoopuser tee -a /home/hadoopuser/.ssh/known_hosts
